      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white">
              {t('projects.auRooms.title')}
            </h1>
            <span className="px-3 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded-full text-xs font-medium">
              {t('projects.categories.scheduleViewer')}
            </span>
          </div>
          <p className="text-xl text-gray-600 dark:text-gray-300">
            {t('projects.auRooms.subtitle')}
          </p>
        </div>
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
            {t('projects.auRooms.aboutProject')}
          </h2>
          <p className="text-gray-700 dark:text-gray-300 mb-4 leading-relaxed">
            {t('projects.auRooms.description')}
          </p>
          <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            {t('projects.auRooms.longDescription')}
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  {t('projects.auRooms.feature1')}
                </h3>
              </div>
              <p className="text-gray-700 dark:text-gray-300">
                {t('projects.auRooms.feature1Desc')}
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  {t('projects.auRooms.feature2')}
                </h3>
              </div>
              <p className="text-gray-700 dark:text-gray-300">
                {t('projects.auRooms.feature2Desc')}
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  {t('projects.auRooms.feature3')}
                </h3>
              </div>
              <p className="text-gray-700 dark:text-gray-300">
                {t('projects.auRooms.feature3Desc')}
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
              <div className="flex items-center mb-3">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                  {t('projects.auRooms.feature4')}
                </h3>
              </div>
              <p className="text-gray-700 dark:text-gray-300">
                {t('projects.auRooms.feature4Desc')}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            ...
            <div>
              <strong className="text-gray-900 dark:text-white block mb-1">{t('projects.institution')}:</strong>
