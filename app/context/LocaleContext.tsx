...
const translations = {
  da: {
    ...
    projects: {
      title: 'Projekter',
      description: 'En samling af nyttige projekter skabt af OCaml og DAT5 klassen på Aarhus Universitet.',
      exploreProjects: 'Udforsk vores projekter!',
      developer: 'Udvikler',
      category: 'Kategori',
      keyFeatures: 'Nøglefunktioner',
      viewProject: 'Se Projekt',
      visitWebsite: 'Besøg Hjemmeside',
      moreProjects: 'Flere Projekter Kommer Snart',
      stayTuned: 'Hold øje med flere nyttige projekter fra DAT5 fællesskabet!',
      ...
      krawl: {
        title: 'Krawl',
        subtitle: 'Din fredagsaften, planlagt',
        aboutProject: 'Om Krawl',
        description: 'En app til at planlægge og gennemføre fredagsbar-ture. Find 50+ fredagsbarer, optimer din rute og del den med venner.',
        longDescription: "Krawl er den ultimative fredagsbar-app for universitetsstuderende i Danmark. Uanset om du planlægger en tur med vennerne eller bare vil finde den nærmeste fredagsbar, gør Krawl det nemt. Se fredagsbarer i nærheden på et interaktivt kort, byg den perfekte rute og del den med din gruppe. Under turen kan I følge hinandens fremskridt i realtid og tjekke ind ved hver bar.",
        feature1: 'Interaktivt kort',
        feature1Desc: 'Udforsk 50+ fredagsbarer i nærheden af dit universitet med info om åbningstider, drinkstilbud og anmeldelser.',
        feature2: 'Ruteoptimering',
        feature2Desc: 'Krawl beregner automatisk den mest effektive gårute mellem dine valgte barer, så I slipper for omveje.',
        feature3: 'Social deling',
        feature3Desc: 'Del din planlagte rute med venner, inviter grupper og følg hinandens position under turen i realtid.',
        feature4: 'Statistik',
        feature4Desc: 'Se et overblik over aftenens highlights efter turen med check-ins, rute og oplevelser.',
        platform: 'Platform',
        visitKrawl: 'Besøg krawl.dk',
      },
  ...
  en: {
    ...
    projects: {
      title: 'Projects',
      description: 'A collection of useful projects created by OCaml and the DAT5 class at Aarhus University.',
      ...
      stayTuned: 'Stay tuned for more useful projects from the DAT5 community!',
      ...
      krawl: {
        title: 'Krawl',
        subtitle: 'Your Friday night, planned',
        aboutProject: 'About Krawl',
        description: 'An app for planning and executing Friday bar crawls. Discover 50+ Friday bars, optimize your route and share it with friends.',
        longDescription: "Krawl is the ultimate Friday bar app for university students in Denmark. Whether you're planning a night out with friends or just looking for the nearest Friday bar, Krawl makes it easy. Browse nearby Friday bars on an interactive map, build the perfect route, and share it with your group. During the crawl, track each other's progress in real-time and check in at every bar.",
        feature1: 'Interactive Map',
        feature1Desc: 'Explore 50+ Friday bars near your university with info on opening hours, drink specials, and community reviews.',
        feature2: 'Route Optimization',
        feature2Desc: 'Krawl automatically calculates the most efficient walking route between your selected bars, eliminating unnecessary detours.',
        feature3: 'Social Sharing',
        feature3Desc: 'Share your planned route with friends, invite groups, and track everyone in real-time during the crawl.',
        feature4: 'Statistics',
        feature4Desc: "See a summary of the evening's highlights after your crawl with check-ins, route and moments captured.",
        platform: 'Platform',
        visitKrawl: 'Visit krawl.dk',
      },
